                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <label> Total da venda: R$ <?= $_SESSION['totalCesta'] ?> </label><br><br>
                                    <?php
                                        $id_venda = $_GET['id'];
                                        $parcelas = $_GET['parcelas'];
                                    ?>

                                    <form role="form" action="venda/agendaVencimentos.php?id=<?=$id_venda?>&parcelas=<?=$parcelas?>" method="post">
                                                ...
                                                <div class="row">
                                                    <div class='col-sm-6'>
                                                        ...
                                                        <div class=''>
                                                            ...
                                                            <input class="form-control" name="valor_parcela<?=$i?>" type="number" step="0.1" value="<?= round($_SESSION['totalCesta']/$parcelas, PHP_ROUND_HALF_UP) ?>">
                                                        </div>
