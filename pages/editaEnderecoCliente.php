                        ...
                        <div class="panel-body">
                            ...
                            foreach($endereco_cliente as $endereco) { ?>
                                        ...
                                        <div class="col-lg-12">
                                            <div class="form-group ">
                                                <label>Rua:</label>
                                                <input class="form-control" value="<?=$endereco['rua']?>" name="rua" required>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                <label>Número:</label>
                                                <input type="number" class="form-control" value="<?=$endereco['numero']?>" name="numero" required>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                <label>Bairro:</label>
                                                <input  class="form-control" value="<?= $endereco['bairro'] ?>" name="bairro" required>
                                            </div>
                                        </div>
                                          ...
                                          <div class="col-lg-12">
                                            <div class="form-group">
                                                <label>Cidade:</label>
                                                <input class="form-control" value="<?= $endereco['cidade'] ?>" name="cidade">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-lg-12">
                                            <div class="form-group">
                                                ...
                                                <input  class="form-control" value="<?= $endereco['complemento'] ?>" name="complemento" required>
                                            </div>
                                        </div>
