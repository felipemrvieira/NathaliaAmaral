        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <h1 class="page-header">Adicionar ao Estoque</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
    ...
    <div class="panel-body">
        <div class="row">
          <?php
            ...
            <div class="col-lg-6">
                <form action="estoque.adiciona.php" method="post" role="form">
                  ...
                  <div class="form-group col-md-6">
                      ...
                      <input required type="text" name="codigo_nf" class="form-control">
                  </div>

                  <div class="form-group col-md-6">
                    <label> Quantidade de entrada: </label>
                    <input type="number" min="1" name="qtd_produto" class="form-control">
                  ...
                  <div class="form-group col-md-12">
                    ...
                    <input required type="number" min="0.01" step="0.01" name="valor_produto" class="form-control" placeholder="Valor do item na nota">
                  </div>
